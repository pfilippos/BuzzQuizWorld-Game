...
public class Game {
    ...
    public int GetRandomInt(){
        if(AmountOfPlayers==1){
            ...
            int randomNum = ThreadLocalRandom.current().nextInt(1, 6); //[1,5]
            return randomNum;
        }
    }
    ...
    /***
     * highscoreFile ,as the name suggests, creates the file with the highscores.
     * In the case of one Player, the function checks whether the score he got in his last game is higher than his previous
     * highest score and updates the highscore.
     * In the case of two Players, the functions decides who is the winner by checking whose score is higher. A win is then added
     * to the winner in the file of Highscore
     * @param p1
     * @param p2
     * @return ar
     */
